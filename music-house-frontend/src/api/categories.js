...
export const getCategories = async (
  ...
  try {
    const response = await axios.get(
      `${BASE_URL}/categories?page=${page}&size=${size}&sort=${sort}`
    )
...
export const getCategoryById = async (idCategory) => {
  try {
    const response = await axios.get(`${BASE_URL}/categories/${idCategory}`)
    return response.data
  } catch (error) {
    handleApiError(error)
  }
...
export const searchCategoryName = async (
  name = '',
  page = 0,
  size = 2,
  sort = 'categoryName,asc'
  ...
  try {
    const response = await axios.get(
      `${BASE_URL}/categories/search?name=${name}&page=${page}&size=${size}&sort=${sort}`
    )
    return response.data
  } catch (error) {
    handleApiError(error)
