...
export const deleteFaq = async (idFaq) => {
  try {
    const response = await axios.delete(`${BASE_URL}/faq/${idFaq}`)
    return response.data
  } catch (error) {
    handleApiError(error)
  }
...
export const updateFaq = async ({ idFaq, answer, active }) => {
  try {
    const response = await axios.patch(`${BASE_URL}/faq`, {
      idFaq,
      answer,
      active
    })
...
export const getFaqById = async (idFaq) => {
  try {
    const response = await axios.get(`${BASE_URL}/faq/${idFaq}`)
    return response.data
  } catch (error) {
    handleApiError(error)
  }
