...
public interface InstrumentRepository extends JpaRepository<Instrument, UUID> {
     ...
     *
     * @param category
     *         la categoría de los instrumentos que se desea encontrar.
     *
     ...
     *
     * @param theme
     *         el tema de los instrumentos que se desea encontrar.
     *
    ...
    /**
     * Encuentra una lista de instrumentos cuyo nombre contenga una cadena específica, ignorando mayúsculas y
     * minúsculas.
     *
     * @param name
     *         la cadena que debe estar contenida en el nombre de los instrumentos.
     *
     * @return una lista de instrumentos cuyos nombres contienen la cadena especificada, ignorando mayúsculas y
     *         minúsculas.
     *         <p>
     *         Ejemplo en la base de datos:
